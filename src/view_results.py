...
#     make_plot(f['molecule980/orientation1/fzvals'][:,:,0])
    f=h5py.File('/l/reischt1/threeAtoms.hdf5', 'r')
    print f.keys()
    view_2(f['molecule1/orientation1/fzvals'][:,:,40,0], f['molecule101/orientation1/fzvals'][:,:,40,0])
    view_2(f['molecule1/orientation1/solution'][:,:,0], f['molecule1/orientation1/fzvals'][:,:,25,0])
    view_2(f['molecule101/orientation1/solution'][:,:,0], f['molecule101/orientation1/fzvals'][:,:,25,0])